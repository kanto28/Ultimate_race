...
>
  <head>
    ...
    <!-- Fonts -->
    <link rel="preconnect" href="<?php echo base_url('https://fonts.googleapis.coms');?>" /> 
    <link rel="preconnect" href="<?php echo base_url('https://fonts.gstatic.com');?>" crossorigin />
    <link
      href="<?php echo base_url('https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap');?>"
      rel="stylesheet"
    />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Team Race</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                    <a href="<?php echo site_url('Etape/liste_etape'); ?>" class="menu-link">
                      <div data-i18n="Blank">Liste Etape</div>
                    </a>
                </li>

                <li class="menu-item">
                    <a href="<?php echo site_url('Coureur/coureur_affectation'); ?>" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?php echo base_url('assets/assets/img/avatars/ito.jpg');?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?= $this->session->userdata('equipe') ?></span>
                    ...
                    <li>
                      <a class="dropdown-item" href="<?php echo site_url('Users/profil'); ?>">
