...
>
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Ultimate Team Race</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Ultimate Team Race! 👋</h4>
              <p class="mb-4">Veuillez vous connecter</p>
              <?php echo isset($error) ? "<div style='color: red;'>{$error}</div>" : ''; ?>
              <form id="formAuthentication" class="mb-3" method="POST" action="<?php echo site_url('Login/connecter_user');?>">
                <div class="mb-3">
              ...
              <p class="text-center">
                <span>Ete vous Admin?</span>
                <a href="<?php echo site_url('Admin/index'); ?>">
                  <span>Connecter ADMIN</span>
                </a>
              </p>
            </div>
          </div>
    ...
    <!-- <div class="buy-now">
      <a
        href="<?php echo base_url('https://themeselection.com/products/sneat-bootstrap-html-admin-template/s');?>"
        target="_blank"
